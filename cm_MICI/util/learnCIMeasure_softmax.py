...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 18 18:02:42 2022
...
def learnCIMeasure_softmax(Bags, Labels, Parameters, trueInitMeasure=None):
    ...
    ## Set up variables
    Analysis = []
    nSources = Bags[0].shape[1] ## number of sources
    ...
    n_bags = len(Bags)
    nPntsBags = [bag.shape[0] for k, bag in enumerate(Bags)]   
    
    sec_start_inds = np.zeros(nSources)
    nElem_prev = 0
