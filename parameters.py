# -*- coding: utf-8 -*-
"""
Created on Sat Sep  7 14:23:46 2019
...
#    parser.add_argument('--starting_parameters', help='Initial parameters when training from scratch. (0 uses pre-training on ImageNet.)', default='/resnet18_epoch_400.pth', type=str)
    parser.add_argument('--model', help='Neural network model', default='vgg16', type=str)
    
    ## Hyperparameters
    parser.add_argument('--NUM_CLASSES', help='Number of classes in the data set.', default=10, type=int)
