...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 22 17:58:31 2022
...
from cam_functions import ActivationCAM, OutputScoreCAMWhiteningNorm
...
#    SAMPLE_IDX = 5 ## Airplane sample in PASCAL test dataset
    ...
    if (parameters.model == 'vgg16'):
        for layer_idx in parameters.layers:
            activation_models[str(layer_idx)] = OutputScoreCAMWhiteningNorm(model=model, target_layers=[model.features[layer_idx]], use_cuda=parameters.cuda)
...
###############################################################################
    ...
    new_save_path =  '/mil_selection_kl_divergence_pos_from_neg_with_inverted_stage_1_7_vs_1_whitening_norm'
