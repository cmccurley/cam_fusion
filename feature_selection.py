...
## Custom packages
import feature_selection_parameters
...
#    SAMPLE_IDX = 5 ## Airplane sample in PASCAL test dataset
    ...
    ## Import parameters 
    args = None
    parameters = feature_selection_parameters.set_parameters(args)
...
#    new_save_path =  '/sort_entropy_seed_scorecam'
    new_save_path =  '/sort_exhaustive_iou_stage_1_all_with_flips'
